...
const Hero = () => {
  return (
    <section className="h-screen w-full max-md:w-[100vw] p-0 m-0 bg-hero max-md:bg-size-[50%] bg-no-repeat bg-cover bg-center">
      <div className="max-sm:flex hidden w-full h-full bg-no-repeat bg-cover relative">
        <img src={hero2} alt="HeroImg" />
        <div className="absolute top-16 w-[full] px-10 items-center ">
          <img src={logo} alt="Logo" />
          <h2 className="text-center pt-2 cinzel-decorative-regular">
            Elegante - Exclusivo{" "}
            <strong className="text-primaryYellow">- Extraordinário</strong>
          </h2>
          ...
          <div className="flex justify-center -mt-2 ">
            <Paragraph className="cinzel font-extrabold">
              Baner - hinjawadi road, pune near hinjawadi, phase - 1
            </Paragraph>
          </div>
        </div>
        <div className="absolute bottom-0 lef-0 m-8">
          <button className="bg-white text-black p-2 rounded-lg font-semibold">
            Download Broucher
          </button>
        </div>
      </div>
