...
const HighlightImage = () => {
  return (
    <div className="bg-highlight bg-no-repeat bg-cover bg-bottom w-[80%] max-md:w-full h-[602px] max-md:h-auto relative rounded-full max-md:hidden flex justify-center items-center">
